...
exports.TextBlock = exports.ColumnsBlock = exports.ImgBlock = exports.TitleBlock = void 0;
...
var ColumnsBlock = /*#__PURE__*/function (_Block3) {
  ...
  _createClass(ColumnsBlock, [{
    key: "toHTML",
    value: function toHTML() {
      return (0, _utils.row)(this.value.map(_utils.col).join(''), (0, _utils.css)(this.options.styles));
    }
  }]);
...
},{"../utils":"utils.js"}],"assets/img.jpg":[function(require,module,exports) {
module.exports = "/img.8582ead4.jpg";
...
var _img = _interopRequireDefault(require("./assets/img.jpg"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var model = [new _blocks.TitleBlock('Your ad could be here', {
  tag: 'h2',
  styles: {
...
}), new _blocks.ColumnsBlock(['This is a pure JavaScript application', 'I like JavaScript'], {
  styles: {
...
}), new _blocks.TextBlock('Here comes the text, blah blah', {
  styles: {
...
exports.model = model;
},{"./classes/blocks":"classes/blocks.js","./assets/img.jpg":"assets/img.jpg"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
